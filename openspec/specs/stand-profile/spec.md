...
Профиль стенда задаёт capability и привязки слотов. По нему каталог шаблонов собирается в конкретные сценарии или помечается skipped.
...
- **WHEN** профиль не задан флагом и переменной
- **THEN** система использует упакованный `profiles/invest-stand.yaml` с заполненными bindings текущих техник каталога
...
- **WHEN** у шаблона `memory-poisoning` в профиле заполнены все слоты
